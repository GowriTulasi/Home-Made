...
# Email settings (You must configure actual credentials in environment for safety)
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USER = 'tulasibhavanam123@gmail.com'
EMAIL_PASSWORD = 'swbd lsmb wxea befw'
...
@app.route('/products')
def products():
    return redirect(url_for('veg_pickles'))  # optional
